...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Background color...
        ...
        'outline' => 'bg-white hover:bg-sky-50/50 dark:bg-zinc-700 dark:hover:bg-zinc-600/75',
        'danger' => 'bg-red-700 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-500',
    ...
    ->add(match ($variant) { // Text color...
        ...
        'outline' => 'text-sky-900 dark:text-white',
        'danger' => 'text-white',
    ...
    ->add(match ($variant) { // Border color...
        ...
        'outline' => 'border border-sky-900 dark:border-zinc-600 dark:hover:border-zinc-600',
         default => '',
    })
