...
@php
    ...
    $classes = Flux::classes()
        ...
        ->add(match($color) {
            ...
            'sky' => [
                '[--callout-border:var(--color-sky-700)] dark:[--callout-border:color-mix(in_oklab,var(--color-sky-900),transparent_50%)]',
                '[--callout-background:var(--color-sky-50)] dark:[--callout-background:color-mix(in_oklab,var(--color-sky-800),transparent_90%)]',
                '[--callout-heading:var(--color-sky-700)] dark:[--callout-heading:var(--color-sky-400)]',
                '[--callout-text:var(--color-sky-700)] dark:[--callout-text:var(--color-sky-300)]',
                '[--callout-icon:var(--color-sky-700)] dark:[--callout-icon:var(--color-sky-400)]',
            ],
            'red' => [
